...
- The post-port graphics north star is a Metal-native HD/4K flexible-world platform:
  ...
  - useful quality lessons include crisp zoom-readable units, wide zoom-out readability, dense battlefield composition, strong terrain/vegetation/building detail, careful arrows/fire/smoke/impact rendering, low input latency, and avoiding fuzzy visuals or unnatural over-smoothed motion
