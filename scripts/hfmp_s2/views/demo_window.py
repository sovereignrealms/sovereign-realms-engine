...
class DemoWindow(pf.Window):
    ...
    def __init__(self):
        super(DemoWindow, self).__init__("HFMP S2 Field Test", (25, 25, DemoWindow.WIDTH, DemoWindow.HEIGHT), 
    ...
    def update(self):
        ...
        self.label_colored_wrap("Field Command:", (255, 255, 255))

        self.layout_row_dynamic(140, 1)
        self.group("Faction", pf.NK_WINDOW_BORDER, factions_group)
        ...
        self.layout_row_dynamic(30, 1)
        self.button_label("Diagnostics", on_performance)
        ...
        self.layout_row_dynamic(30, 1)
        self.button_label("Save / Load", on_session)

        self.layout_row_dynamic(30, 1)
        self.button_label("Script Console", on_console)

        self.layout_row_dynamic(30, 1)
        self.button_label("Exit Field Test", on_exit)
