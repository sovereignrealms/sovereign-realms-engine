...
#define VEC_PROTOTYPES(scope, name, type)                                                       \
    ...
    scope int  vec_##name##_indexof (vec(name) *vec, type t, bool (*comparator)(type*, type*));\
    ...
    scope void vec_##name##_subtract(vec(name) *a, vec(name) *b, bool (*comparator)(type*, type*));
