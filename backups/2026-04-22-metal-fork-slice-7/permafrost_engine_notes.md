...
- The first verified Metal result is now a little deeper than cold launch:
  ...
  - the current world-feedback slice is still intentionally narrow: unit/building selection shapes now render on Metal, but drag-box UI, minimap, gameplay validation, and later parity features are still pending
