...
- The first verified Metal result is now a little deeper than cold launch:
  ...
  - the current world-feedback slice is still intentionally narrow: unit/building selection shapes plus drag-box UI now render on Metal, but minimap, gameplay validation, and later parity features are still pending
