...
- `partial` The Metal backend now verifies cold launch, visible startup UI/menu, visible terrain, a first real terrain-texturing pass, first static-mesh rendering, first skinned-mesh rendering, first world-selection overlays, drag-box UI selection, first healthbars, a first minimap render with terrain, unit dots, and clipped camera-frustum overlay, translucent map-overlay quads, a first scripted gameplay smoke pass, the richer Python 3 Session UI save/load roundtrip, live terrain fog-of-war shading, and a first visible water slice; broader normal play, full reflection/refraction water parity, textured meshes/foliage, richer terrain-material parity, and editor support are still pending migration work.
