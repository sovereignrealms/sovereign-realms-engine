...
- Current phase: `fork scaffold verified; shell wording cleanup started`
...
- `pending` Replace stock faction framing and prototype naming with HFMP-specific terminology without breaking the proven Mac baseline.
- `pending` Define the first faction roster and 3-5 signature characters with non-magic bonus skills.
