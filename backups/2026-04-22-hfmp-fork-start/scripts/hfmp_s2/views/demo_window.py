...
class DemoWindow(pf.Window):
    ...
    def __init__(self):
        super(DemoWindow, self).__init__("HFMP S2 Prototype", (25, 25, DemoWindow.WIDTH, DemoWindow.HEIGHT), 
    ...
    def update(self):
        ...
        self.label_colored_wrap("Active Command:", (255, 255, 255))

        self.layout_row_dynamic(140, 1)
        self.group("Command", pf.NK_WINDOW_BORDER, factions_group)
        ...
        self.layout_row_dynamic(30, 1)
        self.button_label("Exit Prototype", on_exit)
