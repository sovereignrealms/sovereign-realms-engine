...
bool S_PickleObjgraph(PyObject *obj, SDL_RWops *stream)
{
    ...
    PyErr_SetString(PyExc_NotImplementedError,
        "Python object graph pickling is unavailable on Python 3 in the current macOS port.");
    return false;
}
...
PyObject *S_UnpickleObjgraph(SDL_RWops *stream)
{
    (void)stream;
    PyErr_SetString(PyExc_NotImplementedError,
        "Python object graph unpickling is unavailable on Python 3 in the current macOS port.");
    return NULL;
}
...
PyObject *S_Pickle_PlainHeapSubtype(PyTypeObject *type)
{
    (void)type;
    PyErr_SetString(PyExc_NotImplementedError,
        "Python heap subtype restoration is unavailable on Python 3 in the current macOS port.");
    return NULL;
}
