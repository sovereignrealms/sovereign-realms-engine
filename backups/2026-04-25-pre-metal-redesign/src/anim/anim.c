...
void A_GetCurrPoseMats(uint32_t uid, size_t *out_njoints, mat4x4_t *out_curr_pose)
{
    PERF_ENTER();
    ...
    A_GetPoseMats(ctx->data, ctx->curr_clip_idx, ctx->curr_frame, out_njoints, out_curr_pose);
    PERF_RETURN_VOID();
}
