...
"    return 1.0;\n"
"}\n"
"static float shadow_factor(float4 light_space_pos, depth2d<float> shadow_map, sampler shadow_sampler, float bias) {\n"
...
"    return (proj.z - bias > closest_depth) ? 1.0 : 0.0;\n"
"}\n"
...
"        float shadow = shadow_factor(in.light_space_pos, shadow_map, shadow_sampler, uniforms.shadow_params.y);\n"
