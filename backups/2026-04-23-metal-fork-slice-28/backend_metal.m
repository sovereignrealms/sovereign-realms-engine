...
"    return 1.0;\n"
"}\n"
"fragment float4 terrain_fragment(TerrainVertexOut in [[stage_in]], constant TerrainUniforms &uniforms [[buffer(1)]], device const uchar *fog_buff [[buffer(2)]], device const uchar *water_buff [[buffer(3)]], texture2d_array<float> terrain_textures [[texture(0)]], texture2d<float> water_dudv_map [[texture(1)]], texture2d<float> water_normal_map [[texture(2)]], sampler terrain_sampler [[sampler(0)]]) {\n"
